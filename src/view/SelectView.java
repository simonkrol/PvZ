...
/**
 * The Select View class, used to get the heigh and width of game being created
...
public class SelectView
{
	...
	private void initialize()
	{
		...
		JLabel lblWidthsAndHeights = new JLabel(
				"<html>Enter the # height and width of the game above.<br/>Widths and heights over 10 will cause<br/> the game to look weird</html>");
		lblWidthsAndHeights.setBounds(10, 83, 303, 66);
		frame.getContentPane().add(lblWidthsAndHeights);
	}

	/**
	 * Get the entered width value
	 * @return The width
	 */
	public int getWidth()
	{
